...
namespace XueFuShop.Models
{
    public sealed class UserInfo
    {
        ...
        private int workingPostID = 0;
        private int studyPostID = 0;
        private string postName;
        private int department = int.MinValue;
        private string idCard = string.Empty;
        private DateTime postStartDate = DateTime.Now;
        ...
        {
            get { return this.workingPostID; }
            set { this.workingPostID = value; }
        }

        public int StudyPostID
        {
            get { return this.studyPostID; }
            set { this.studyPostID = value; }
        }
        ...
        public DateTime PostStartDate
        {
            get { return this.postStartDate; }
            set { this.postStartDate = value; }
        }
