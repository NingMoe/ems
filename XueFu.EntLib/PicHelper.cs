    ...
    public class Watermark
    {
        ...
        public bool Create()
        {
            try
            {
                ...
                Font f2 = new Font("华文新魏", 20, _fontStyle);
                Font f3 = new Font("华文新魏", 22, _fontStyle);
                ...
                g.DrawString("特别授予", f2, new SolidBrush(Color.FromArgb(255, 0, 0, 0)), ThirdPointF, StrFormat);
                ...
                g.DrawString("荣誉", f2, new SolidBrush(Color.FromArgb(255, 0, 0, 0)), ThirdPointF, StrFormat);
