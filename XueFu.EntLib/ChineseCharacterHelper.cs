        ...
        public static string GetFirstLetter(string chineseCharacter)
        {
            ...
            for (int i = 0; i < chArray.Length; i++)
            {
                ...
                if (regex.IsMatch(input))
                {
                    ...
                    else if (input.CompareTo("°Ë") < 0)
                    {
                        str = str + "A";
                    }
                    else if (input.CompareTo("àê") < 0)
                    {
                        str = str + "B";
                    }
                    else if (input.CompareTo("…ö") < 0)
                    {
                        str = str + "C";
                    }
                    else if (input.CompareTo("ŠŠ") < 0)
                    {
                        str = str + "D";
                    }
                    ...
                    else if (input.CompareTo("ê¸") < 0)
                    {
                        str = str + "F";
                    }
                    else if (input.CompareTo("îþ") < 0)
                    {
                        str = str + "G";
                    }
                    else if (input.CompareTo("¼¥") < 0)
                    ...
                    else if (input.CompareTo("ßÇ") < 0)
                    {
                        str = str + "J";
                    }
                    else if (input.CompareTo("À¬") < 0)
                    {
                        str = str + "K";
                    }
                    else if (input.CompareTo("‡`") < 0)
                    ...
                    else if (input.CompareTo("àÞ") < 0)
                    {
                        str = str + "N";
                    }
                    else if (input.CompareTo("Šr") < 0)
                    {
                        str = str + "O";
                    }
                    else if (input.CompareTo("Æß") < 0)
                    {
                        str = str + "P";
                    }
                    else if (input.CompareTo("’") < 0)
                    ...
                    else if (input.CompareTo("Øí") < 0)
                    {
                        str = str + "R";
                    }
                    else if (input.CompareTo("Ëû") < 0)
                    {
                        str = str + "S";
                    }
                    else if (input.CompareTo("ÍÛ") < 0)
                    {
                        str = str + "T";
                    }
                    else if (input.CompareTo("Ï¦") < 0)
                    {
                        str = str + "W";
                    }
                    else if (input.CompareTo("Ñ¾") < 0)
                    {
                        str = str + "X";
                    }
                    else if (input.CompareTo("Ž‰") < 0)
                    {
                        str = str + "Y";
                    }
                    else if (input.CompareTo("…ø") < 0)
                    {
                        str = str + "Z";
                    }
                    else
