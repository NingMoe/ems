...
namespace XueFu.EntLib
{
    ...
    public sealed class StringHelper
    {
        ...
        /// <returns></returns>
        public static string EqualString(string str1, string str2)
        {
            return EqualString(str1, str2, ',');
        }
            ...
            if (!string.IsNullOrEmpty(str1))
            {
                ...
                foreach (string info in str1.Split(new char[]{ splitChar}, StringSplitOptions.RemoveEmptyEntries))
                {
                    ...
                    if (srcString.IndexOf(item, StringComparison.Ordinal) != -1)
                    {
                        ...
                        if (string.IsNullOrEmpty(srcString)) break;
                    }
                }
                ...
                if (!string.IsNullOrEmpty(srcString) && !string.IsNullOrEmpty(EqualString(srcString, str1, splitChar)))
                {
                    srcString = SubString(srcString, str1, splitChar);
                }
            }
            return srcString;
        }
