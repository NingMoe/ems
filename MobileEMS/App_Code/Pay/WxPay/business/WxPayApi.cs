...
namespace WxPayAPI
{
    public class WxPayApi
    {
	    ...
	    */
        ...
        {
            return DownloadBill(inputObj, 6);
        }
        /**
        * 下载对账单
	    ...
	    */
        ...
        {
            return UnifiedOrder(inputObj, 6);
        }
        /**
        * 
        * 统一下单
