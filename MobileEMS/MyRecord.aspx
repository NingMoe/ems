<%@ Page Language="C#" MasterPageFile="~/Course.Master" AutoEventWireup="true" CodeBehind="MyRecord.aspx.cs" Inherits="MobileEMS.MyRecord" Title="无标题页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <input type="hidden" id="hidSelecttype" value="4">
    <input type="hidden" id="hHideNav" value="1">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
<script id="record-tmpl" type="text/tmpl">
    {{~it:v:i}}
   		<div class="ke">
			...
			<div class="ke_info">
				...
				{{?}}
				<div class="tit">{{=v.TestCateName}}</div>
				<div class="scorse">{{=v.Scorse}}分</div>
			</div>
		</div>
    {{~}}
</script>
