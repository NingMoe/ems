    ...
    public sealed class ProductDAL : IProduct
    {
        ...
        public int AddProduct(ProductInfo product)
        {
            SqlParameter[] pt = new SqlParameter[] {
                ...
                new SqlParameter("@spelling", SqlDbType.NVarChar),
                new SqlParameter("@color", SqlDbType.NVarChar),
                new SqlParameter("@fontStyle", SqlDbType.NVarChar),
                new SqlParameter("@productNumber", SqlDbType.NVarChar),
                ...
                new SqlParameter("@isSpecial", SqlDbType.Int),
                ...
                new SqlParameter("@accessory", SqlDbType.NVarChar),
                new SqlParameter("@relationProduct", SqlDbType.NVarChar),
                new SqlParameter("@relationArticle", SqlDbType.NVarChar),
                new SqlParameter("@viewCount", SqlDbType.Int),
                new SqlParameter("@allowComment", SqlDbType.Int),
                new SqlParameter("@commentCount", SqlDbType.Int),
                new SqlParameter("@sumPoint", SqlDbType.Int),
                new SqlParameter("@perPoint", SqlDbType.Decimal),
                new SqlParameter("@photoCount", SqlDbType.Int),
                new SqlParameter("@collectCount", SqlDbType.Int),
                ...
                new SqlParameter("@importActualStorageCount", SqlDbType.Int),
                new SqlParameter("@importVirtualStorageCount", SqlDbType.Int),
                new SqlParameter("@lowerCount", SqlDbType.Int),
                new SqlParameter("@upperCount", SqlDbType.Int),
                new SqlParameter("@attributeClassID", SqlDbType.Int),
                new SqlParameter("@standardType", SqlDbType.Int),
                new SqlParameter("@addDate", SqlDbType.DateTime),
                new SqlParameter("@companyID", SqlDbType.Int),
                new SqlParameter("@sort", SqlDbType.Int),
                new SqlParameter("@courseDate", SqlDbType.NVarChar),
                new SqlParameter("@state", SqlDbType.Int),
                new SqlParameter("@courseURL", SqlDbType.NVarChar),
                new SqlParameter("@salesToolURL", SqlDbType.NVarChar),
            ...
            pt[0x28].Value = product.CompanyID;
            pt[0x29].Value = product.Sort;
            pt[0x2a].Value = product.CourseDate;
            pt[0x2b].Value = product.State;
            pt[0x2c].Value = product.CourseURL;
            pt[0x2d].Value = product.SalesToolURL;
            pt[0x2e].Value = product.Editor;
        ...
        public void PrepareCondition(MssqlCondition mssqlCondition, ProductSearchInfo productSearch)
        {
            ...
            //mssqlCondition.Add("[BrandID]", productSearch.BrandID, ConditionType.Like);
            ...
            mssqlCondition.Add("[CompanyID]", productSearch.InCompanyID, ConditionType.In);
            mssqlCondition.Add("[MarketPrice]", productSearch.MarketPrice, ConditionType.Equal);
            //if (productSearch.IsComplete == 1)
            //{
            //    mssqlCondition.Add("([ProductNumber]='' or [Accessory]='')");
            //}
            if (!string.IsNullOrEmpty(productSearch.NotInClassID))
            {
                mssqlCondition.Add(" [dbo].[" + ShopMssqlHelper.TablePrefix + "CompareSTR]([ClassID],'" + productSearch.NotInClassID + "','|')<>1 ");
            }
            ...
            if (!string.IsNullOrEmpty(productSearch.InBrandID))
            {
                mssqlCondition.Add(" [dbo].[" + ShopMssqlHelper.TablePrefix + "CompareBrand](BrandID,'" + productSearch.InBrandID + "',',')=1 ");
            }
            ...
            if (productSearch.RelationProduct != string.Empty)
            {
                mssqlCondition.Add(" [dbo].[" + ShopMssqlHelper.TablePrefix + "CompareSTR](RelationProduct,'" + productSearch.RelationProduct + "',',')=1 ");
            }
            if (productSearch.Accessory != string.Empty)
            {
                mssqlCondition.Add(" [dbo].[" + ShopMssqlHelper.TablePrefix + "CompareSTR](Accessory,'" + productSearch.Accessory + "',',')=1 ");
            }
            if (!string.IsNullOrEmpty(productSearch.NotLikeName))
            {
                mssqlCondition.Add(" [Name] not like '%" + productSearch.NotLikeName + "%' ");
            }
            if (productSearch.IsSpecialTestSetting > 0)
            {
                mssqlCondition.Add("[ID] IN (SELECT [CourseID] FROM [" + ShopMssqlHelper.TablePrefix + "TestSetting] )");
            }
            if (productSearch.OrderField.StartsWith("Order"))
            {
                mssqlCondition.Add(productSearch.OrderField);
            }
        }
        ...
        public void PrepareProductModel(SqlDataReader dr, List<ProductInfo> productList)
        {
            while (dr.Read())
            {
                ...
                item.Sort = int.Parse(dr["Sort"].ToString());
                item.Editor = dr["Editor"].ToString();
                item.Introduction = dr["Introduction"].ToString();
        ...
        public ProductInfo ReadProduct(int id)
        {
            ...
            using (SqlDataReader reader = ShopMssqlHelper.ExecuteReader(ShopMssqlHelper.TablePrefix + "ReadProduct", pt))
            {
                if (reader.Read())
                {
                    ...
                    info.BrandID = reader[7].ToString();
                    ...
                    info.CompanyID = int.Parse(reader["CompanyID"].ToString());
                    info.Sort = int.Parse(reader["Sort"].ToString());
                    info.Editor = reader["Editor"].ToString();
                }
            }
            return info;
        }
        ...
        public List<ProductInfo> SearchProductList(int currentPage, int pageSize, ProductSearchInfo productSearch, ref int count, int gradeID, decimal disCount)
        {
            ...
            ShopMssqlPagerClass class2 = new ShopMssqlPagerClass();
            class2.TableName = string.Concat(new object[] { "(SELECT ", str, ",IsNULL(Price,MarketPrice*", disCount, ") As CurrentMemberPrice FROM ", ShopMssqlHelper.TablePrefix, "Product LEFT JOIN ", ShopMssqlHelper.TablePrefix, "MemberPrice ON ", ShopMssqlHelper.TablePrefix, "Product.ID=", ShopMssqlHelper.TablePrefix, "MemberPrice.ProductID AND ", ShopMssqlHelper.TablePrefix, "MemberPrice.GradeID=", gradeID.ToString(), ") As Temp" });
            ...
            using (SqlDataReader reader = class2.ExecuteReader())
            {
                while (reader.Read())
                {
                    ...
                    item.BrandID = reader[7].ToString();
        ...
        public void UpdateProduct(ProductInfo product)
        {
            ...
            pt[0x1e].Value = product.CompanyID;
            pt[0x1f].Value = product.Sort;
            pt[0x20].Value = product.CourseDate;
            pt[0x21].Value = product.State;
            pt[0x22].Value = product.CourseURL;
            pt[0x23].Value = product.SalesToolURL;
            pt[0x24].Value = product.Editor;
