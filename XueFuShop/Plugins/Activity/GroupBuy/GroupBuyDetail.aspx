<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupBuyDetail.aspx.cs" Inherits="XueFuShop.Web.GroupBuyDetail" %>
            ...
            <div style="width:100%; overflow:hidden;">          
                <div class="leftBox">
                     <div class="price">
                        ...
                        <%}else{ %>
                        <a href="GroupBuyAdd.aspx?ID=<%=groupBuy.ID%>" target="_blank"><img src="buy.png" /></a>
                        <%} %>
                    </div> 
