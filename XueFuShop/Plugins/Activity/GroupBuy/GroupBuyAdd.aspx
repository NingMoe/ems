<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupBuyAdd.aspx.cs" Inherits="XueFuShop.Web.GroupBuyAdd" %>
    ...
    <div class="main">
        <table cellpadding="0" cellspacing="0" border="0" width="960px">
            <tr class="cartHead">
                ...
                <td>名称</td>
                <td style="width:100px">团购价</td>
                <td style="width:100px">数量</td>
                <td style="width:100px">小计</td>
            </tr>
            <tr class="cartMain" valign="middle">
                <td style="width:100px" class="photo"><a href="/ProductDetail-I<%=product.ID%>.aspx" target="_blank"><img  src="<%=product.Photo%>"  onload="photoLoad(this,60,60)"/></a></td>
                <td style="text-align:left; text-indent:8px;"><a href="/ProductDetail-I<%=product.ID%>.aspx" target="_blank"><%=product.Name%></a></td>
                <td style="width:100px"><%=groupBuy.Price%></td>
                <td style="width:100px"><input  type="text" class="text" value="1" id="BuyCount" name="BuyCount" onblur="changeBuyCount(this.value,<%=groupBuy.EachNumber%>,<%=groupBuy.MaxCount - buyCount%>,<%=groupBuy.Price%>)" /></td>
                <td style="width:100px" id="Statics"><%=groupBuy.Price%></td>
            </tr>
        </table>
        ...
        <div class="add">
            ...
            <ul>
             ...
             <ul>
                ...
                <br /><XueFu:TextBox ID="Address" CssClass="input"  style="width:360px" runat="server" CanBeNull="必填"/></li>
            </ul> 
             <ul>
                <li class="left">&nbsp;</li>
