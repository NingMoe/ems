<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeFile="ExchangeAwardAdd.aspx.cs" Inherits="XueFuShop.Web.ExchangeAwardAdd" %>
<%@ Register Namespace="XueFu.EntLib" Assembly="XueFu.EntLib" TagPrefix="SkyCES"%>
