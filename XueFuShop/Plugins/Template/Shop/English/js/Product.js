...
function searchProduct(){
    ...
    var url="/English/ProductAjax.aspx?"+searchContion+"&SearchType="+searchType+"&Page="+tempPage;
...
function changeShowDisplay(){
    ...
    var content="";
    if(productShowWay=="2"){
        content="<img src=\""+templatePath+"Images/pictureOff.png\" title=\"图片方式\" onclick=\"selectShowWay(1)\"  /> <img src=\""+templatePath+"Images/listOn.png\" title=\"列表方式\" onclick=\"selectShowWay(2)\" />";
    }
    else{
        content="<img src=\""+templatePath+"Images/pictureOn.png\" title=\"图片方式\" onclick=\"selectShowWay(1)\"  /> <img src=\""+templatePath+"Images/listOff.png\" title=\"列表方式\" onclick=\"selectShowWay(2)\" />";
    }
