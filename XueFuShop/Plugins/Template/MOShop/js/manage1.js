	...
	$(document).ready(function(){	
		...
		$("#completion_rate").find(".form_tgl_button").click(function() {
			$("#completion_rate").validate({
		        ...
		        messages:{ //提示报错 
		        	EvaluationName: "评估名称，姓名和岗位至少填写一个",
		           	Name: "评估名称，姓名和岗位至少填写一个",
		            PostId:"评估名称，姓名和岗位至少填写一个",
		        }, 
			});
		});
		/*增加评估验证*/
        ...
        /*报表筛选*/
        $(".content_select").find("li").click(function() {
