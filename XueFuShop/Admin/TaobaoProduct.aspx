<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="TaobaoProduct.aspx.cs" Inherits="XueFuShop.Admin.TaobaoProduct" Title="无标题页" %>
...
<div class="add">
	<ul>
		...
		<li class="right"><asp:TextBox ID="AppKey" CssClass="input" runat="server" Width="400px" CanBeNull="必填"></asp:TextBox></li>
	</ul>
	<ul>
		<li class="left">AppSecret：</li>
		<li class="right"><asp:TextBox ID="AppSecret" CssClass="input" runat="server" Width="400px" CanBeNull="必填"></asp:TextBox></li>
	</ul>
	<ul>
		<li class="left">账户名：</li>
		<li class="right"><asp:TextBox ID="NickName" CssClass="input" runat="server" Width="400px" CanBeNull="必填"></asp:TextBox></li>
	</ul>
	<ul>
