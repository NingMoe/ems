<%@ Page Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="XueFuShop.Admin.Menu" %>
<asp:Content ID="MasterContent" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
<div class="position"><img src="Style/Images/PositionIcon.png"  alt=""/>菜单列表</div>
<div  class="listBlock">
    <ul>
       <%foreach(XueFuShop.Models.MenuInfo menu in XueFuShop.BLL.MenuBLL.ReadMenuRootList()){ %>
...
<asp:Repeater ID="RecordList" runat="server">
    <ItemTemplate>
        <tr class="listTableMain" onmousemove="changeColor(this,'#FFFDD7')" onmouseout="changeColor(this,'#FFF')">
            ...
            <td style="width:10%"><img src="Style/Icon/<%#Eval("MenuImage")%>-icon.gif" /></td>	
