<%@ Page Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="XueFuShop.Admin.Admin" %>
...
<div class="action">
        <input type="button"  value=" 添 加 " class="button"  onclick="pop('AdminAdd.aspx',600,350,'管理员添加','AdminAdd')"/>&nbsp;<asp:Button CssClass="button" ID="DeleteButton" Text=" 删 除 " OnClientClick="return checkSelect()" runat="server"  OnClick="DeleteButton_Click"/>&nbsp;<input type="checkbox" name="All" onclick="selectAll(this)" />全选/取消
</div>
</asp:Content>
