<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="FavorableActivityAdd.aspx.cs" Inherits="XueFuShop.Admin.FavorableActivityAdd" Title="无标题页" %>
...
<div class="add">
	<ul>
		<li class="left">标题：</li>
		<li class="right"><XueFu:TextBox CssClass="input" Width="400px" ID="Name" runat="server" CanBeNull="必填"/></li>
	</ul>
	<ul>
		<li class="left">图片：</li>
	...
	<ul>
		<li class="left">介绍：</li>
		<li class="right"><XueFu:TextBox CssClass="input" Width="400px" ID="Content" runat="server" TextMode="MultiLine"  Height="100px"/></li>
	</ul>
	<ul>
		<li class="left">条件：</li>
		<li class="right">
		    <ul>
		        ...
		        <li class="right"><XueFu:TextBox ID="StartDate" CssClass="input" runat="server" Width="140px"  RequiredFieldType="日期时间"  CanBeNull="必填" onfocus="cdr.show(this);"/> 到 <XueFu:TextBox ID="EndDate" CssClass="input" runat="server" Width="140px" RequiredFieldType="日期时间"  CanBeNull="必填"  onfocus="cdr.show(this);" /></li>
	        </ul>	
	        <ul>
	        ...
	        <ul>
		        ...
		        <li class="right"><XueFu:TextBox ID="OrderProductMoney" CssClass="input" runat="server" Width="60px"  CanBeNull="必填" RequiredFieldType="金额"  Text="0"/> 元</li>
	        </ul>
		</li>
	</ul>
	<ul>
		...
		<li class="right">
	        ...
	        <ul>
		        ...
		        <li class="right">
		            ...
		            <input name="ReduceWay" onclick="changeReduceWay()" value="1" type="radio" /> 现金减免 <span id="ReduceMoneyDiv"><XueFu:TextBox CssClass="input" Width="30px" ID="ReduceMoney" runat="server" CanBeNull="必填" RequiredFieldType="金额"  Text="0"/> 元 </span> 
		            <input name="ReduceWay" onclick="changeReduceWay()" value="2" type="radio" /> 价格折扣 <span id="ReduceDiscountDiv"><XueFu:TextBox CssClass="input" Width="30px" ID="ReduceDiscount" runat="server" CanBeNull="必填" RequiredFieldType="金额"  Text="0"/> 折 </span></li>
	        </ul>
	        <ul>
