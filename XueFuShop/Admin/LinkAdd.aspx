<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="LinkAdd.aspx.cs" Inherits="XueFuShop.Admin.LinkAdd" Title="无标题页" %>
...
<div class="add">
	...
	<ul>
		<li class="left">文字：</li>
		<li class="right"><XueFu:TextBox ID="TextDisplay" CssClass="input" runat="server"  Width="400px" /></li>
	</ul>
	</div>
	...
	<ul>
		...
		<li class="right"><XueFu:TextBox ID="URL" CssClass="input" runat="server"  Width="400px"  RequiredFieldType="网页地址"/></li>
	</ul>	
	<ul>
		<li class="left">备注信息：</li>
		<li class="right"><XueFu:TextBox ID="Remark" CssClass="input" runat="server" Width="400px" TextMode="MultiLine" Height="50px" /></li>
	</ul>
</div>		
<div class="action">
