<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.Master" AutoEventWireup="true" CodeBehind="VoteItem.aspx.cs" Inherits="XueFuShop.Admin.VoteItem" %>
...
<div class="add">
	<ul>
		<li class="left">选项：</td>
		<li class="right"><XueFu:TextBox ID="ItemName" CssClass="input" runat="server" Width="400px" CanBeNull="必填" /></td>
	</tr>
</div>
<div class="action">
