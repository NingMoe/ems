<%@ Page Language="C#" MasterPageFile="MasterPage.Master" AutoEventWireup="true" CodeBehind="Sitemap.aspx.cs" Inherits="XueFuShop.Admin.Sitemap" %>
<asp:Content ID="MasterContent" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
<div class="position"><img src="Style/Images/PositionIcon.png"  alt=""/>网站地图</div>
<ul class="search">
...
<div class="add">
    <ul>
		<li class="left">域名：</li>
		<li class="right">http://<asp:TextBox CssClass="input" Width="300px" ID="Domain" runat="server"></asp:TextBox>  
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="域名不能为空" ControlToValidate="Domain" Display="Dynamic"></asp:RequiredFieldValidator></li>
	</ul>
	<ul>
