...
namespace XueFuShop.Admin
{
    public partial class ProductComment : AdminBasePage
    {
        ...
        {
            ResponseHelper.Redirect((((("ProductComment.aspx?Action=search&" + "Name=" + this.Name.Text + "&") + "Title=" + this.Title.Text + "&") + "StartPostDate=" + this.StartPostDate.Text + "&") + "EndPostDate=" + this.EndPostDate.Text + "&") + "Status=" + this.Status.Text);
        }
