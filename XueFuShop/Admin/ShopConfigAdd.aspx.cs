    ...
    public partial class ShopConfigAdd : AdminBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.Page.IsPostBack)
            {
                ...
                this.Title.Text = ShopConfig.ReadConfigInfo().Title;
                ...
                this.TestInterval.Text = ShopConfig.ReadConfigInfo().TestInterval.ToString();
                this.IconFontPath.Text = ShopConfig.ReadConfigInfo().IconFontPath;
                this.ManageIconFontPath.Text = ShopConfig.ReadConfigInfo().ManageIconFontPath;
            }
        }
